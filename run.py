...
def main(repo_path,cuda,required_callee,loglevel):
    ...
    for root, _, files in os.walk(repo_path):
        for file in files:
            if file.endswith('.py'):
                ...
                for caller,callees in caller_callee_relations.items():
                ...
                score = evaluate_correctness(code,modified_code)
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--corr_repo_path",type=str,default=".")
    arg_parser.add_argument("--required_callee", type=str, default="log")
    arg_parser.add_argument("--loglevel", type=str, default="debug")

    args = arg_parser.parse_args()

    main(args.repo_path,args.corr_repo_path,args.required_callee,args.loglevel)
